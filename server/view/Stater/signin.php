...
<body background="../../public/images/background.jpg" style="
  ...
  <div class="container-sm bg-white text-center " style="height: 500px;
    ...
    <form action="#">
      ...
      <input type="password" class="form-control mt-4" id="password" maxlength="24" minlength="8" placeholder="Password"
        autofocus required onkeyup="passwordStrengthCheck()">
      <p class="text-danger" id="notValidPass" style="font-size: .8rem;"></p>
      <input type="password" class="form-control mt-4" id="ConfirmPassword" placeholder="Confirm Password" autofocus required onkeyup="confirmPass()">
